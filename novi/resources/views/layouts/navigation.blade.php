    ...
    >
        ...
        <div class="flex-1 overflow-y-auto px-4 py-6">
            ...
            <div class="space-y-1">
                ...
                <a
                    <a href="{{ route('admin.customers.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-gray-100" style="color: var(--brand-text);">
                    <span class="text-lg">♙</span>
                    <span>Asiakkaat</span>
                </a>
